    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 10.5, color: "#9AA0AB", letterSpacing: "-0.01em", marginTop: -2 }}>가상공유거래 정산</div>
        </div>
      </div>
      ...
      <div style={{
        ...
        background: "#F4F5F7", padding: "8px 14px", borderRadius: 999,
        width: 280, color: "#9AA0AB",
      }}>
        {Icons.Search}
        <span style={{ fontSize: 13 }}>동·정산ID·트랜잭션 검색</span>
        <span style={{ marginLeft: "auto", fontSize: 11, color: "#9AA0AB" }} className="mono">⌘K</span>
      </div>
      ...
      {/* Bell */}
      <button style={{
        width: 38, height: 38, borderRadius: 999, background: "#F4F5F7",
        display: "grid", placeItems: "center", color: "#374151", position: "relative",
      }}>
        {Icons.Bell}
        <span style={{
          position: "absolute", top: 7, right: 8,
          width: 8, height: 8, borderRadius: 999, background: "#F43F5E",
